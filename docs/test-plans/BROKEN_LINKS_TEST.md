# ✅ Broken Links Report Test

## 📋 Test Overview
**Test File:** `tests/verify-broken-links.spec.ts`
**Status:** 🔄 IN PROGRESS
**Date:** April 15, 2026
...
| 4 | Click on Broken Links | Broken Links page loads |
...
5. "Broken Links" sub-menu item is visible and clickable.
...
| Broken Links item | `xpath=//ul[contains(@class,'el-menu--popup')]//li[contains(@class,'el-menu-item') and normalize-space()='Broken Links']` |
